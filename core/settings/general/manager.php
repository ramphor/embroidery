...
use Embroidery\Global_CSS_File;
...
class Manager extends BaseManager {
	...
	const META_KEY = '_embroidery_general_settings';
			...
			foreach ( $sections as $section_name => $section_data ) {
				...
				foreach ( $section_data['controls'] as $control_name => $control_data ) {
					if ( isset( $settings[ $control_name ] ) ) {
						$one_list_control_name = str_replace( 'embroidery_', '', $control_name );
	...
	private function add_panel_tabs() {
		Controls_Manager::add_tab( self::PANEL_TAB_LIGHTBOX, __( 'Lightbox', 'embroidery' ) );
	}
}
