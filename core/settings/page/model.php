...
class Model extends BaseModel {
	...
	public function get_css_wrapper_selector() {
		return 'body.embroidery-page-' . $this->get_id();
	}
	...
	public function get_panel_page_settings() {
		return [
			'title' => __( 'Document Settings', 'embroidery' ),
		];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Document Settings', 'embroidery' ),
		...
		$page_title_selector = SettingsManager::get_settings_managers( 'general' )->get_model()->get_settings( 'embroidery_page_title_selector' );
		...
		$this->add_control(
			'hide_title',
			[
				'label' => __( 'Hide Title', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'No', 'embroidery' ),
				'label_on' => __( 'Yes', 'embroidery' ),
				'description' => sprintf(
					/* translators: %s: Setting Page URL */
					__( 'Not working? You can set a different selector for the title in the <a href="%s" target="_blank">Settings page</a>.', 'embroidery' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Delete All Content', 'embroidery' ),
				'text' => __( 'Delete', 'embroidery' ),
				'button_type' => 'warning',
				'event' => 'embroidery:clearPage',
			]
		);
		...
		$this->start_controls_section(
			'section_page_style',
			[
				'label' => __( 'Page Style', 'embroidery' ),
