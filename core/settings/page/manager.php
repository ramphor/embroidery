...
use Embroidery\Core\Settings\Base\Manager as BaseManager;
...
class Manager extends BaseManager {
	...
	const TEMPLATE_CANVAS = 'embroidery_canvas';

	const META_KEY = '_embroidery_page_settings';
	...
	public static function add_page_templates( $post_templates ) {
		$post_templates = [
			self::TEMPLATE_CANVAS => __( 'Embroidery', 'embroidery' ) . ' ' . __( 'Canvas', 'embroidery' ),
		] + $post_templates;
	...
	public function template_include( $template ) {
		if ( is_singular() ) {
			...
			if ( self::TEMPLATE_CANVAS === $page_template ) {
				$template = EMBROIDERY_PATH . '/includes/page-templates/canvas.php';
			}
		}
