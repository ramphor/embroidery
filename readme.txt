=== Embroidery Page Builder ===
Contributors: pojo.me, KingYes, ariel.k, jzaltzberg, mati1000, pojosh, bainternet, yehudah
Tags: page builder, editor, landing page, drag-and-drop, embroidery, visual editor, wysiwyg, design, maintenance mode, coming soon, under construction, website builder, landing page builder, front-end builder
...
It's time for **[Embroidery Page Builder](https://embroidery.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)**.

= Faster. Much faster. =
Instant reaction was a key feature we wanted to achieve. And we did. Instant drag & drop page builder, instant live edit, instant page load. The speed of Embroidery is not matched by any other page builder, free or paid. This makes the interface fun and easy to work with, as well as reduces the time it takes to design.

= Live design. Truly live. =
Never again work on the backend and guess what the frontend will look like. With Embroidery page builder, you edit the page and simultaneously see exactly how it looks like. Embroidery features live design & inline editing, so the whole process of writing and designing is done directly on the page, with no need to press update or go to preview mode.

= Surprises you won’t see anywhere else. =
With Embroidery's unique features, you can create websites that have that certain 'designer touch'. Among our page builder features are: Box Shadows, Background Overlays, Hover Effects, Headline Effects, Animations, Shape Dividers, Gradient Backgrounds and much more.

= Template Library. =
We've added [Template Library](https://library.embroidery.com/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme), which includes a collection of 100+ beautiful WordPress templates, made for you by our top notch designers. You can save and reuse them on different pages, or export them to whole different websites with our page builder.

= Mobile First. Mobile Editing. =
Embroidery Page Builder comes with an exclusive toolset, that lets you create truly a responsive website in a whole new and visual way. From different font size, padding and margin per device, to reverse column ordering, this is the most powerful mobile page builder for creating perfect responsive websites.
...
Design your entire page in the page builder. No header, no footer, just Embroidery. This is perfect for landing pages and coming soon pages. Canvas works on any theme, and lets you get rid of the header area so you get a blank template to work on.

= Built-in Maintenance Mode & Under Construction. =
Need to get your site offline for maintenance? Use Embroidery page builder's built in Maintenance Mode & Coming Soon feature to show your visitors an under construction / coming soon page.

= Try Embroidery Pro. The Best Page Builder For WordPress. =
If you thought Embroidery is full of useful features, check out Embroidery Pro! Embroidery Pro extends the basic features even further, and allows you to control your entire website with Embroidery.

Design [forms](https://embroidery.com/pro-v140-form-integrations/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)  live on the frontend, customize your blog posts visually, incorporate slides, WooCommerce, global widgets, custom CSS and much more. [Upgrade now to Embroidery Pro!](https://embroidery.com/pro/?utm_source=wp-repo&utm_medium=link&utm_campaign=readme)
...
= Developer API. =
Embroidery page builder is free and open source. It's the perfect page builder plugin to be extended and integrated further. It was created and developed with the developer in mind, and we have already seen some truly remarkable addons already developed.
We have created an extensive [API documentation](https://github.com/pojome/embroidery/tree/master/docs), to help you get started and learn just how to integrate with Embroidery.
...
- [Arabic](https://translate.wordpress.org/locale/ar/default/wp-plugins/embroidery) - (ar) - in progress
...
* Fix: Unknown text input in Group Controls ([#1926](https://github.com/pojome/embroidery/issues/1926))
...
* Fix: Remove `maxlength` attribute from color picker input ([#298](https://github.com/pojome/embroidery/issues/298))
