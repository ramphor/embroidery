module.exports = function( grunt ) {
	...
	grunt.initConfig( {
		...
		wp_readme_to_markdown: {
			github: {
				options: {
					wordpressPluginSlug: 'embroidery',
					travisUrlRepo: 'https://travis-ci.org/pojome/embroidery',
					gruntDependencyStatusUrl: 'https://david-dm.org/pojome/embroidery',
					coverallsRepo: 'pojome/embroidery',
		...
		replace: {
			plugin_main: {
				...
				replacements: [
					...
					{
						from: /EMBROIDERY_VERSION', '.*?'/g,
						to: 'EMBROIDERY_VERSION\', \'<%= pkg.version %>\''
					},
					{
						from: /EMBROIDERY_PREVIOUS_STABLE_VERSION', '.*?'/g,
						to: 'EMBROIDERY_PREVIOUS_STABLE_VERSION\', \'<%= grunt.config.get( \'prev_stable_version\' ) %>\''
					}
				]
			},
