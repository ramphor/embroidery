...
},{"embroidery-frontend/handlers/accordion":4,"embroidery-frontend/handlers/alert":5,"embroidery-frontend/handlers/counter":7,"embroidery-frontend/handlers/global":8,"embroidery-frontend/handlers/image-carousel":9,"embroidery-frontend/handlers/progress":10,"embroidery-frontend/handlers/section":11,"embroidery-frontend/handlers/tabs":12,"embroidery-frontend/handlers/text-editor":13,"embroidery-frontend/handlers/toggle":14,"embroidery-frontend/handlers/video":15,"embroidery-frontend/handlers/widget":16}],2:[function(require,module,exports){
...
},{"../utils/hooks":21,"./handler-module":3,"embroidery-frontend/elements-handler":1,"embroidery-frontend/modules/stretch-element":17,"embroidery-frontend/utils/anchors":18,"embroidery-frontend/utils/lightbox":19,"embroidery-frontend/utils/youtube":20,"embroidery-utils/hot-keys":22}],3:[function(require,module,exports){
...
},{"embroidery-frontend/handlers/base-tabs":6}],5:[function(require,module,exports){
module.exports = function( $scope, $ ) {
...
module.exports = HandlerModule.extend( {
	...
	getDefaultSettings: function() {
		return {
			selectors: {
				tabTitle: '.embroidery-tab-title',
				tabContent: '.embroidery-tab-content'
			},
			classes: {
				active: 'embroidery-active'
			},
			showTabFn: 'show',
			hideTabFn: 'hide',
			toggleSelf: true,
...
},{"embroidery-frontend/handler-module":3}],7:[function(require,module,exports){
module.exports = function( $scope, $ ) {
...
},{"embroidery-frontend/handler-module":3}],9:[function(require,module,exports){
var HandlerModule = require( 'embroidery-frontend/handler-module' ),
...
ImageCarouselHandler = HandlerModule.extend( {
	getDefaultSettings: function() {
		return {
			selectors: {
				carousel: '.embroidery-image-carousel'
			}
		};
	},
...
},{"embroidery-frontend/handler-module":3}],10:[function(require,module,exports){
module.exports = function( $scope, $ ) {
...
},{"embroidery-frontend/handler-module":3}],12:[function(require,module,exports){
var TabsModule = require( 'embroidery-frontend/handlers/base-tabs' );
...
},{"embroidery-frontend/handlers/base-tabs":6}],13:[function(require,module,exports){
var HandlerModule = require( 'embroidery-frontend/handler-module' ),
	TextEditor;
...
TextEditor = HandlerModule.extend( {
	...
	getDefaultSettings: function() {
		return {
			...
			classes: {
				dropCap: 'embroidery-drop-cap',
				dropCapLetter: 'embroidery-drop-cap-letter'
			}
		};
	},
...
},{"embroidery-frontend/handler-module":3}],14:[function(require,module,exports){
var TabsModule = require( 'embroidery-frontend/handlers/base-tabs' );
...
},{"embroidery-frontend/handlers/base-tabs":6}],15:[function(require,module,exports){
var HandlerModule = require( 'embroidery-frontend/handler-module' ),
	VideoModule;
...
VideoModule = HandlerModule.extend( {
	getDefaultSettings: function() {
		return {
			selectors: {
				imageOverlay: '.embroidery-custom-embed-image-overlay',
				videoWrapper: '.embroidery-wrapper',
				videoFrame: 'iframe'
			}
		};
	},
	...
	getLightBox: function() {
		return embroideryFrontend.utils.lightbox;
	},
...
},{"embroidery-frontend/handler-module":3}],16:[function(require,module,exports){
module.exports = function( $scope, $ ) {
	if ( ! embroideryFrontend.isEditMode() ) {
		return;
	}
