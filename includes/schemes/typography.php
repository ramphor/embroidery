...
/**
 * Embroidery typography scheme.
 *
 * Embroidery typography scheme class is responsible for initializing a scheme
 * for typography.
 *
 * @since 1.0.0
 */
class Scheme_Typography extends Scheme_Base {
	...
	public function get_title() {
		return __( 'Typography', 'embroidery' );
	}
	...
	public function get_disabled_title() {
		return __( 'Default Fonts', 'embroidery' );
	}
	...
	public function get_scheme_titles() {
		return [
			self::TYPOGRAPHY_1 => __( 'Primary Headline', 'embroidery' ),
			self::TYPOGRAPHY_2 => __( 'Secondary Headline', 'embroidery' ),
			self::TYPOGRAPHY_3 => __( 'Body Text', 'embroidery' ),
			self::TYPOGRAPHY_4 => __( 'Accent Text', 'embroidery' ),
		];
	}
	...
	public function print_template_content() {
		?>
		<div class="embroidery-panel-scheme-items"></div>
		<?php
	}
}
