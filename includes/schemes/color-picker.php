...
/**
 * Embroidery color picker scheme.
 *
 * Embroidery color picker scheme class is responsible for initializing a scheme
 * for color pickers.
 *
 * @since 1.0.0
 */
class Scheme_Color_Picker extends Scheme_Color {
	...
	public static function get_description() {
		return __( 'Choose which colors appear in the editor\'s color picker. This makes accessing the colors you chose for the site much easier.', 'embroidery' );
	}
	...
	protected function _get_current_scheme_title() {
		return __( 'Color Picker', 'embroidery' );
	}
}
