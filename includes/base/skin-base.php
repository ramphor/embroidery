 ...
 * Skin Base.
 *
 * An abstract class to register new skins for Embroidery widgets. Skins allows
...
abstract class Skin_Base {
	 ...
	 *
	 * Example usage:
	 * `add_action( 'embroidery/element/{widget_id}/{section_id}/before_section_end', [ $this, 'register_controls' ] );`
	 *
	 * @since 1.0.0
	 * @access protected
	 */
