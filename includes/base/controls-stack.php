...
abstract class Controls_Stack {
	 ...
	 * The configuration.
	 *
	 * Holds the configuration used to generate the Embroidery editor. It includes
	...
	public function start_controls_section( $section_id, array $args ) {
		 ...
		 *
		 * Fires before Embroidery section starts in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'embroidery/element/before_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "embroidery/element/{$section_name}/{$section_id}/before_section_start", $this, $args );
		...
		if ( null !== $this->_current_section ) {
			wp_die( sprintf( 'Embroidery: You can\'t start a section before the end of the previous section: `%s`', $this->_current_section['section'] ) ); // XSS ok.
		}
		 ...
		 * After section start.
		 *
		 * Fires after Embroidery section starts in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'embroidery/element/after_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "embroidery/element/{$section_name}/{$section_id}/after_section_start", $this, $args );
	}
	...
	public function end_controls_section() {
		 ...
		 * Before section end.
		 *
		 * Fires before Embroidery section ends in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'embroidery/element/before_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "embroidery/element/{$section_name}/{$section_id}/before_section_end", $this, $args );
		 ...
		 * After section end.
		 *
		 * Fires after Embroidery section ends in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'embroidery/element/after_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "embroidery/element/{$section_name}/{$section_id}/after_section_end", $this, $args );
	}
	...
	public function start_controls_tabs( $tabs_id ) {
		if ( null !== $this->_current_tab ) {
			wp_die( sprintf( 'Embroidery: You can\'t start tabs before the end of the previous tabs: `%s`', $this->_current_tab['tabs_wrapper'] ) ); // XSS ok.
		}
	...
	public function start_controls_tab( $tab_id, $args ) {
		if ( ! empty( $this->_current_tab['inner_tab'] ) ) {
			wp_die( sprintf( 'Embroidery: You can\'t start a tab before the end of the previous tab: `%s`', $this->_current_tab['inner_tab'] ) ); // XSS ok.
		}
