...
class Control_Dimensions extends Control_Base_Units {
	...
	public function content_template() {
		$dimensions = [
			...
			'right' => __( 'Right', 'embroidery' ),
			'bottom' => __( 'Bottom', 'embroidery' ),
			'left' => __( 'Left', 'embroidery' ),
		];
		?>
					...
					foreach ( $dimensions as $dimension_key => $dimension_title ) :
						...
						<li class="embroidery-control-dimension">
							...
							<# if ( -1 === _.indexOf( allowed_dimensions, '<?php echo $dimension_key; ?>' ) ) { #>
								...
								<# } #>
									/>
							<label for="<?php echo $control_uid; ?>" class="embroidery-control-dimension-label"><?php echo $dimension_title; ?></label>
						</li>
					<?php endforeach; ?>
					<li>
						<button class="embroidery-link-dimensions tooltip-target" data-tooltip="<?php _e( 'Link values together', 'embroidery' ); ?>">
							<span class="embroidery-linked">
								<i class="fa fa-link" aria-hidden="true"></i>
								<span class="embroidery-screen-only"><?php esc_html_e( 'Link values together', 'embroidery' ); ?></span>
							</span>
							<span class="embroidery-unlinked">
								<i class="fa fa-chain-broken" aria-hidden="true"></i>
								<span class="embroidery-screen-only"><?php esc_html_e( 'Unlinked values', 'embroidery' ); ?></span>
							</span>
						</button>
					</li>
				</ul>
