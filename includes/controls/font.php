	...
	public function content_template() {
		...
		<div class="embroidery-control-field">
			...
			<div class="embroidery-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="embroidery-control-font-family" data-setting="{{ data.name }}">
					<option value=""><?php _e( 'Default', 'embroidery' ); ?></option>
					<optgroup label="<?php _e( 'System', 'embroidery' ); ?>">
						<# _.each( getFontsByGroups( 'system' ), function( fontType, fontName ) { #>
						<option value="{{ fontName }}">{{{ fontName }}}</option>
						<# } ); #>
					</optgroup>

					<optgroup label="<?php _e( 'Google', 'embroidery' ); ?>">
