...
abstract class Base_Control {
	 ...
	 * Retrieve features.
	 *
	 * Get the list of all the available features. Currently Embroidery uses only
	 * the `UI` feature.
	 *
	 * @since 1.5.0
	 * @access public
	...
	final public function print_template() {
		?>
		<script type="text/html" id="tmpl-embroidery-control-<?php echo esc_attr( $this->get_type() ); ?>-content">
			<div class="embroidery-control-content">
