...
class Control_Box_Shadow extends Control_Base_Multiple {
	...
	public function get_sliders() {
		return [
			'blur' => [
				'label' => __( 'Blur', 'embroidery' ),
				'min' => 0,
				'max' => 100,
			],
			'spread' => [
				'label' => __( 'Spread', 'embroidery' ),
				'min' => -100,
				'max' => 100,
			],
			'horizontal' => [
				'label' => __( 'Horizontal', 'embroidery' ),
				'min' => -100,
				'max' => 100,
			],
			'vertical' => [
				'label' => __( 'Vertical', 'embroidery' ),
				'min' => -100,
				'max' => 100,
			],
		];
	...
	public function content_template() {
		...
		<div class="embroidery-control-field">
			<label class="embroidery-control-title"><?php _e( 'Color', 'embroidery' ); ?></label>
			<div class="embroidery-control-input-wrapper">
				<input data-setting="color" class="embroidery-shadow-color-picker" type="text" placeholder="<?php echo esc_attr( 'Hex/rgba', 'embroidery' ); ?>" data-alpha="true"{{{ defaultColorValue }}} />
			</div>
		</div>
		<?php
		foreach ( $this->get_sliders() as $slider_name => $slider ) :
			...
			?>
			<div class="embroidery-shadow-slider">
				<label for="<?php echo $control_uid; ?>" class="embroidery-control-title"><?php echo $slider['label']; ?></label>
				<div class="embroidery-control-input-wrapper">
					<div class="embroidery-slider" data-input="<?php echo $slider_name; ?>"></div>
					<div class="embroidery-slider-input">
