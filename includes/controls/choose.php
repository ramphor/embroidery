	...
	public function content_template() {
		...
		<div class="embroidery-control-field">
			...
			<div class="embroidery-control-input-wrapper">
				<div class="embroidery-choices">
					<# _.each( data.options, function( options, value ) { #>
					<input id="<?php echo $control_uid; ?>" type="radio" name="embroidery-choose-{{ data.name }}-{{ data._cid }}" value="{{ value }}">
					<label class="embroidery-choices-label tooltip-target" for="<?php echo $control_uid; ?>" data-tooltip="{{ options.title }}" title="{{ options.title }}">
						<i class="{{ options.icon }}" aria-hidden="true"></i>
						<span class="embroidery-screen-only">{{{ options.title }}}</span>
					</label>
					<# } ); #>
				</div>
			</div>
