...
class Control_URL extends Control_Base_Multiple {
	...
	public function content_template() {
		...
		?>
		<div class="embroidery-control-field embroidery-control-url-external-{{{ data.show_external ? 'show' : 'hide' }}}">
			<label for="<?php echo $control_uid; ?>" class="embroidery-control-title">{{{ data.label }}}</label>
			<div class="embroidery-control-input-wrapper">
				<input id="<?php echo $control_uid; ?>" type="url" class="embroidery-input" data-setting="url" placeholder="{{ data.placeholder }}" />
				<label for="<?php echo $more_input_control_uid; ?>" class="embroidery-control-url-more tooltip-target" data-tooltip="<?php _e( 'Link Options', 'embroidery' ); ?>">
					<i class="fa fa-cog" aria-hidden="true"></i>
				</label>
				<input id="<?php echo $more_input_control_uid; ?>" type="checkbox" class="embroidery-control-url-more-input">
				<div class="embroidery-control-url-more-options">
					<div class="embroidery-control-url-option">
						<input id="<?php echo $is_external_control_uid; ?>" type="checkbox" class="embroidery-control-url-option-input" data-setting="is_external">
						<label for="<?php echo $is_external_control_uid; ?>"><?php echo __( 'Open in new window', 'embroidery' ); ?></label>
					</div>
					<div class="embroidery-control-url-option">
						<input id="<?php echo $nofollow_control_uid; ?>" type="checkbox" class="embroidery-control-url-option-input" data-setting="nofollow">
						<label for="<?php echo $nofollow_control_uid; ?>"><?php echo __( 'Add nofollow', 'embroidery' ); ?></label>
					</div>
				</div>
			</div>
		</div>
