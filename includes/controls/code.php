	...
	public function content_template() {
		...
		<div class="embroidery-control-field">
			...
			<div class="embroidery-control-input-wrapper">
				<textarea id="<?php echo $control_uid; ?>" rows="{{ data.rows }}" class="embroidery-input-style embroidery-code-editor" data-setting="{{ data.name }}"></textarea>
			</div>
		</div>
		<# if ( data.description ) { #>
