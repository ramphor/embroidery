...
class Control_Repeater extends Base_Data_Control {
	 ...
	 * Import repeater.
	 *
	 * Used as a wrapper method for inner controls while importing Embroidery
	...
	public function content_template() {
		?>
		<label>
			<span class="embroidery-control-title">{{{ data.label }}}</span>
		</label>
		<div class="embroidery-repeater-fields"></div>
		<div class="embroidery-button-wrapper">
			<button class="embroidery-button embroidery-button-default embroidery-repeater-add" type="button">
				<i class="eicon-plus" aria-hidden="true"></i><?php _e( 'Add Item', 'embroidery' ); ?>
			</button>
		</div>
		<?php
	}
