	...
	public function content_template() {
		...
		<div class="embroidery-control-field">
			...
			<div class="embroidery-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" class="embroidery-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php _e( 'Select Icon', 'embroidery' ); ?>">
					<option value=""><?php _e( 'Select Icon', 'embroidery' ); ?></option>
