...
/**
 * Embroidery popover toggle control.
 *
 ...
 *                             Default is `__( 'Default', 'embroidery' )`.
 * @param string $label_on     Optional. The label for the "checked" state.
 *                             Default is `__( 'Custom', 'embroidery' )`.
	...
	public function content_template() {
		...
		<div class="embroidery-control-field">
			...
			<div class="embroidery-control-input-wrapper">
				<input id="<?php echo $control_uid; ?>-custom" class="embroidery-control-popover-toggle-toggle" type="radio" name="embroidery-choose-{{ data.name }}-{{ data._cid }}" value="{{ data.return_value }}">
				<label class="embroidery-control-popover-toggle-toggle-label" for="<?php echo $control_uid; ?>-custom">
					<i class="eicon-edit" aria-hidden="true"></i>
					<span class="embroidery-screen-only"><?php esc_html_e( 'Edit', 'embroidery' ); ?></span>
				</label>
				<# if ( 'switcher' === data.toggle_type ) { #>
					<input id="<?php echo $control_uid; ?>-default" type="radio" name="embroidery-choose-{{ data.name }}-{{ data._cid }}" value="">
					<label class="embroidery-control-popover-toggle-reset-label tooltip-target" for="<?php echo $control_uid; ?>-default" data-tooltip="<?php echo __( 'Back to default', 'embroidery' ); ?>" data-tooltip-pos="s">
						<i class="fa fa-repeat" aria-hidden="true"></i>
						<span class="embroidery-screen-only"><?php esc_html_e( 'Back to default', 'embroidery' ); ?></span>
					</label>
				<# } #>
			</div>
		</div>
