...
/**
 * Embroidery image dimensions control.
 *
...
class Control_Image_Dimensions extends Control_Base_Multiple {
	...
	public function content_template() {
		if ( ! $this->_is_image_editor_supports() ) : ?>
			<div class="embroidery-panel-alert embroidery-panel-alert-danger">
				<?php _e( 'The server does not have ImageMagick or GD installed and/or enabled! Any of these libraries are required for WordPress to be able to resize images. Please contact your server administrator to enable this before continuing.', 'embroidery' ); ?>
			</div>
		<?php
			return;
		endif;
		...
		<div class="embroidery-control-field">
			<label class="embroidery-control-title">{{{ data.label }}}</label>
			<div class="embroidery-control-input-wrapper">
				<div class="embroidery-image-dimensions-field">
					<?php $control_uid = $this->get_control_uid( 'width' ); ?>
					<input id="<?php echo $control_uid; ?>" type="text" data-setting="width" />
					<label for="<?php echo $control_uid; ?>" class="embroidery-image-dimensions-field-description"><?php _e( 'Width', 'embroidery' ); ?></label>
				</div>
				<div class="embroidery-image-dimensions-separator">x</div>
				<div class="embroidery-image-dimensions-field">
					<?php $control_uid = $this->get_control_uid( 'height' ); ?>
					<input id="<?php echo $control_uid; ?>" type="text" data-setting="height" />
					<label for="<?php echo $control_uid; ?>" class="embroidery-image-dimensions-field-description"><?php _e( 'Height', 'embroidery' ); ?></label>
				</div>
				<button class="embroidery-button embroidery-button-success embroidery-image-dimensions-apply-button"><?php _e( 'Apply', 'embroidery' ); ?></button>
			</div>
		</div>
		<?php
	}
