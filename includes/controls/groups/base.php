...
abstract class Group_Control_Base implements Group_Control_Interface {
	...
	public function get_base_group_classes() {
		return 'embroidery-group-control-' . static::get_type() . ' embroidery-group-control';
	}
	...
	protected function add_group_args_to_field( $control_id, $field_args ) {
		...
		$field_args['classes'] = $this->get_base_group_classes() . ' embroidery-group-control-' . $control_id;
	 ...
	 *
	 * This way Embroidery can apply condition logic to a specific control in a
	 * group control.
	 *
	 * @since 1.2.0
	 * @access private
	 ...
	 * group control, Embroidery needs to apply the selector to different fields.
