...
class Group_Control_Background extends Group_Control_Base {
	...
	private static function init_background_types() {
		return [
			'classic' => [
				'title' => _x( 'Classic', 'Background Control', 'embroidery' ),
				'icon' => 'fa fa-paint-brush',
			],
			'gradient' => [
				'title' => _x( 'Gradient', 'Background Control', 'embroidery' ),
				'icon' => 'fa fa-barcode',
			],
			'video' => [
				'title' => _x( 'Background Video', 'Background Control', 'embroidery' ),
	...
	public function init_fields() {
		...
		$fields['background'] = [
			'label' => _x( 'Background Type', 'Background Control', 'embroidery' ),
		...
		$fields['color'] = [
			'label' => _x( 'Color', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'title' => _x( 'Background Color', 'Background Control', 'embroidery' ),
			'selectors' => [
		...
		$fields['color_stop'] = [
			'label' => _x( 'Location', 'Background Control', 'embroidery' ),
		...
		$fields['color_b'] = [
			'label' => _x( 'Second Color', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::COLOR,
			'default' => '#f2295b',
			'render_type' => 'ui',
			'condition' => [
		...
		$fields['gradient_type'] = [
			'label' => _x( 'Type', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'linear' => _x( 'Linear', 'Background Control', 'embroidery' ),
				'radial' => _x( 'Radial', 'Background Control', 'embroidery' ),
			],
			'default' => 'linear',
			'render_type' => 'ui',
			'condition' => [
		...
		$fields['gradient_angle'] = [
			'label' => _x( 'Angle', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'deg' ],
			'default' => [
				'unit' => 'deg',
		...
		$fields['gradient_position'] = [
			'label' => _x( 'Position', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'center center' => _x( 'Center Center', 'Background Control', 'embroidery' ),
				'center left' => _x( 'Center Left', 'Background Control', 'embroidery' ),
				'center right' => _x( 'Center Right', 'Background Control', 'embroidery' ),
				'top center' => _x( 'Top Center', 'Background Control', 'embroidery' ),
				'top left' => _x( 'Top Left', 'Background Control', 'embroidery' ),
				'top right' => _x( 'Top Right', 'Background Control', 'embroidery' ),
				'bottom center' => _x( 'Bottom Center', 'Background Control', 'embroidery' ),
				'bottom left' => _x( 'Bottom Left', 'Background Control', 'embroidery' ),
				'bottom right' => _x( 'Bottom Right', 'Background Control', 'embroidery' ),
			],
		...
		$fields['image'] = [
			'label' => _x( 'Image', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::MEDIA,
			'title' => _x( 'Background Image', 'Background Control', 'embroidery' ),
			'selectors' => [
		...
		$fields['position'] = [
			...
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'embroidery' ),
				'top left' => _x( 'Top Left', 'Background Control', 'embroidery' ),
				'top center' => _x( 'Top Center', 'Background Control', 'embroidery' ),
				'top right' => _x( 'Top Right', 'Background Control', 'embroidery' ),
				'center left' => _x( 'Center Left', 'Background Control', 'embroidery' ),
		...
		$fields['attachment'] = [
			'label' => _x( 'Attachment', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'embroidery' ),
				'scroll' => _x( 'Scroll', 'Background Control', 'embroidery' ),
				'fixed' => _x( 'Fixed', 'Background Control', 'embroidery' ),
			],
			'selectors' => [
		...
		$fields['repeat'] = [
			'label' => _x( 'Repeat', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'embroidery' ),
				'no-repeat' => _x( 'No-repeat', 'Background Control', 'embroidery' ),
				'repeat' => _x( 'Repeat', 'Background Control', 'embroidery' ),
				'repeat-x' => _x( 'Repeat-x', 'Background Control', 'embroidery' ),
				'repeat-y' => _x( 'Repeat-y', 'Background Control', 'embroidery' ),
			],
			'selectors' => [
		...
		$fields['size'] = [
			'label' => _x( 'Size', 'Background Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => _x( 'Default', 'Background Control', 'embroidery' ),
				'auto' => _x( 'Auto', 'Background Control', 'embroidery' ),
				'cover' => _x( 'Cover', 'Background Control', 'embroidery' ),
				'contain' => _x( 'Contain', 'Background Control', 'embroidery' ),
			],
			'selectors' => [
		...
		$fields['video_fallback'] = [
			'label' => _x( 'Background Fallback', 'Background Control', 'embroidery' ),
			'description' => __( 'This cover image will replace the background video on mobile and tablet devices.', 'embroidery' ),
			'type' => Controls_Manager::MEDIA,
			'label_block' => true,
			'condition' => [
				'background' => [ 'video' ],
