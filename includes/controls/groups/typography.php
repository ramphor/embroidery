...
class Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$default_fonts = SettingsManager::get_settings_managers( 'general' )->get_model()->get_settings( 'embroidery_default_generic_fonts' );
		...
		$fields['font_family'] = [
			'label' => _x( 'Family', 'Typography Control', 'embroidery' ),
		...
		$fields['font_size'] = [
			'label' => _x( 'Size', 'Typography Control', 'embroidery' ),
		...
		$fields['font_weight'] = [
			'label' => _x( 'Weight', 'Typography Control', 'embroidery' ),
		...
		$fields['text_transform'] = [
			'label' => _x( 'Transform', 'Typography Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'embroidery' ),
				'uppercase' => _x( 'Uppercase', 'Typography Control', 'embroidery' ),
				'lowercase' => _x( 'Lowercase', 'Typography Control', 'embroidery' ),
				'capitalize' => _x( 'Capitalize', 'Typography Control', 'embroidery' ),
				'none' => _x( 'Normal', 'Typography Control', 'embroidery' ),
			],
		];

		$fields['font_style'] = [
			'label' => _x( 'Style', 'Typography Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'embroidery' ),
				'normal' => _x( 'Normal', 'Typography Control', 'embroidery' ),
				'italic' => _x( 'Italic', 'Typography Control', 'embroidery' ),
				'oblique' => _x( 'Oblique', 'Typography Control', 'embroidery' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => _x( 'Decoration', 'Typography Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'embroidery' ),
				'underline' => _x( 'Underline', 'Typography Control', 'embroidery' ),
				'overline' => _x( 'Overline', 'Typography Control', 'embroidery' ),
				'line-through' => _x( 'Line Through', 'Typography Control', 'embroidery' ),
				'none' => _x( 'None', 'Typography Control', 'embroidery' ),
			],
		];

		$fields['line_height'] = [
			'label' => _x( 'Line-Height', 'Typography Control', 'embroidery' ),
			'type' => Controls_Manager::SLIDER,
			'default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => _x( 'Letter Spacing', 'Typography Control', 'embroidery' ),
			'type' => Controls_Manager::SLIDER,
			'range' => [
				'px' => [
					'min' => -5,
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Typography', 'Typography Control', 'embroidery' ),
			],
		];
	}
}
