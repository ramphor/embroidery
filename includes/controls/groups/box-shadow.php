...
class Group_Control_Box_Shadow extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['box_shadow'] = [
			'label' => _x( 'Box Shadow', 'Box Shadow Control', 'embroidery' ),
		...
		$controls['box_shadow_position'] = [
			'label' => _x( 'Position', 'Box Shadow Control', 'embroidery' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				' ' => _x( 'Outline', 'Box Shadow Control', 'embroidery' ),
				'inset' => _x( 'Inset', 'Box Shadow Control', 'embroidery' ),
			],
			'condition' => [
				'box_shadow_type!' => '',
			],
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Box Shadow', 'Box Shadow Control', 'embroidery' ),
