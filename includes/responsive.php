...
/**
 * Embroidery responsive class.
 *
 * Embroidery responsive handler class is responsible for setting up Embroidery
...
class Responsive {
	...
	/**
	 * The Embroidery break point prefix.
	 */
	const BREAKPOINT_OPTION_PREFIX = 'embroidery_viewport_';
