...
/**
 * Embroidery repeater element class.
 *
 * Embroidery repeater handler class is responsible for initializing the repeater.
 *
 * @since 1.0.0
 */
class Repeater extends Element_Base {
	 ...
	 *
	 * Initializing Embroidery repeater element.
	 *
	 * @since 1.0.7
	 * @access public
	 *
