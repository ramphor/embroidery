<?php
namespace Embroidery\System_Info\Classes;
...
class Server_Reporter extends Base_Reporter {
	...
	public function get_fields() {
		return [
			...
			'embroidery_library' => 'Embroidery Library',
		];
	}
	...
	public function get_php_version() {
		...
		if ( version_compare( $result['value'], '5.4', '<' ) ) {
			$result['recommendation'] = _x( 'We recommend to use php 5.4 or higher', 'System Info', 'embroidery' );
	...
	public function get_write_permissions() {
		...
		$embroidery_uploads_path = $wp_upload_dir['basedir'] . '/embroidery';

		if ( is_dir( $embroidery_uploads_path ) ) {
			$paths_to_check[ $embroidery_uploads_path ] = 'Embroidery uploads directory';
		}
	 ...
	 * @since 1.0.0
	 */
	public function get_embroidery_library() {
