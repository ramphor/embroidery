...
/**
 * Embroidery WordPress widgets manager class.
 *
 * Embroidery WordPress widgets manager handler class is responsible for
...
class WordPress_Widgets_Manager {
	 ...
	 *
	 * Initializing the WordPress widgets manager in Embroidery editor.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	public function __construct() {
		...
		add_action( 'embroidery/editor/before_enqueue_scripts', [ $this, 'before_enqueue_scripts' ] );
		add_action( 'embroidery/editor/footer', [ $this, 'footer' ] );
	}

	/**
	 * Before enqueue scripts.
	 *
	 * Prints custom scripts required to run WordPress widgets in Embroidery
	 * editor.
	 *
	 * Fired by `embroidery/editor/before_enqueue_scripts` action.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	 ...
	 *
	 * Prints WordPress widgets scripts in Embroidery editor footer.
	 *
	 * Fired by `embroidery/editor/footer` action.
	 *
	 * @since 1.5.0
	 * @access public
	 */
