...
/**
 * Embroidery images manager class.
 *
 * Embroidery images manager handler class is responsible for retrieve images
 * details.
 *
 * @since 1.0.0
 */
class Images_Manager {
	 ...
	 *
	 * Fired by `wp_ajax_embroidery_get_images_details` action.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 *
	 * Fired by `wp_ajax_embroidery_get_image_details` action.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_details( $id, $size, $is_first_time ) {
		if ( ! class_exists( 'Group_Control_Image_Size' ) ) {
			require_once EMBROIDERY_PATH . '/includes/controls/groups/image-size.php';
		}
	 ...
	 *
	 * Initializing Embroidery images manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function __construct() {
		add_action( 'wp_ajax_embroidery_get_image_details', [ $this, 'get_image_details' ] );
		add_action( 'wp_ajax_embroidery_get_images_details', [ $this, 'get_images_details' ] );
	}
}
