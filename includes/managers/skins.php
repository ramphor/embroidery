...
/**
 * Embroidery skins manager class.
 *
 * Embroidery skins manager handler class is responsible for registering and
...
class Skins_Manager {
	 ...
	 * @param Skin_Base   $skin   Embroidery skin.
	 *
	 ...
	 *
	 * @param Widget_Base $widget  Embroidery widget.
	 * @param string      $skin_id Embroidery skin ID.
	 *
	 ...
	 *
	 * Initializing Embroidery skins manager by requiring the skin base class.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function __construct() {
		require EMBROIDERY_PATH . 'includes/base/skin-base.php';
	}
}
