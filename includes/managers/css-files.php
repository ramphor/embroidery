...
/**
 * Embroidery posts CSS manager class.
 *
 * Embroidery posts CSS manager handler class is responsible for creating custom
 * CSS file for posts.
 *
 * @since 1.2.0
 */
class Posts_CSS_Manager {
	 ...
	 *
	 * Initializing the Embroidery posts CSS manager.
	 *
	 * @since 1.2.0
	 * @access public
	 */
	 ...
	 * Init.
	 *
	 * Initialize Embroidery posts CSS manager and create the css directory, if
	 * it doesn't exist.
	 *
	 * @since 1.2.0
	 * @access public
	 ...
	 * export won't contain the post CSS file data used by Embroidery.
	 *
