<?php
namespace Embroidery\Debug;

use Embroidery\System_Info\Main;

/**
 * Embroidery debug class.
 *
 * Embroidery debug handler class is responsible for logging errors and
...
class Debug {
	 ...
	 */
	const OPTION_NAME = 'embroidery_debug_log';
	 ...
	 * Debug log.
	 *
	 * Log Embroidery errors and save them in the database.
	 *
	 * Fired by `wp_ajax_embroidery_debug_log` action.
	 *
	 * @since 1.4.0
	 * @access public
	 */
	 ...
	 * Debug constructor.
	 *
	 * Initializing Embroidery debug and logging errors.
	 *
	 * @since 1.4.0
	 * @access public
	 */
	public function __construct() {
		add_action( 'wp_ajax_embroidery_debug_log', [ $this, 'debug_log' ] );
