...
class Post_CSS_File extends CSS_File {
	...
	const META_KEY = '_embroidery_css';
	...
	*/
	...
	public function get_element_unique_selector( Element_Base $element ) {
		return '.embroidery-' . $this->post_id . ' .embroidery-element' . $element->get_unique_selector();
	}
	...
	*/
	public function enqueue() {
		if ( ! Plugin::$instance->db->is_built_with_embroidery( $this->post_id ) ) {
			return;
		}
	...
	*/
	protected function get_file_handle_id() {
		return 'embroidery-post-' . $this->post_id;
	}
	...
	*/
	...
	protected function render_styles( Element_Base $element ) {
		 ...
		 */
		do_action( 'embroidery/element/before_parse_css', $this, $element );
		 ...
		 * @param Element_Base  $element The element.
		 */
		do_action( 'embroidery/element/parse_css', $this, $element );
	}
}
