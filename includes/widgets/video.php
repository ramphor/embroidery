...
/**
 * Embroidery video widget.
 *
 * Embroidery widget that displays a video player.
 *
 * @since 1.0.0
 */
class Widget_Video extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'video_type',
			[
				'label' => __( 'Video Type', 'embroidery' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'youtube',
				'options' => [
					'youtube' => __( 'YouTube', 'embroidery' ),
					'vimeo' => __( 'Vimeo', 'embroidery' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Link', 'embroidery' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your Vimeo link', 'embroidery' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Link', 'embroidery' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your video link', 'embroidery' ),
				'default' => '',
				'label_block' => true,
				'condition' => [
					'video_type' => 'hosted',
		...
		$this->add_control(
			'heading_youtube',
			[
				'label' => __( 'Video Options', 'embroidery' ),
		...
		$this->add_control(
			'yt_rel',
			[
				'label' => __( 'Suggested Videos', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'condition' => [
					'video_type' => 'youtube',
				],
			]
		...
		$this->add_control(
			'yt_controls',
			[
				'label' => __( 'Player Control', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'yt_showinfo',
			[
				'label' => __( 'Player Title & Actions', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'yt_privacy',
			[
				'label' => __( 'Privacy Mode', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'embroidery' ),
				'condition' => [
					'video_type' => 'youtube',
				],
			]
		...
		$this->add_control(
			'vimeo_title',
			[
				'label' => __( 'Intro Title', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_portrait',
			[
				'label' => __( 'Intro Portrait', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_byline',
			[
				'label' => __( 'Intro Byline', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'vimeo_color',
			[
				'label' => __( 'Controls Color', 'embroidery' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Image Overlay', 'embroidery' ),
			]
		);
		...
		$this->add_control(
			'aspect_ratio',
			[
				'label' => __( 'Aspect Ratio', 'embroidery' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'169' => '16:9',
					'43' => '4:3',
				...
				'default' => '169',
				'prefix_class' => 'embroidery-aspect-ratio-',
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .embroidery-custom-embed-play i' => 'color: {{VALUE}}',
				],
				'separator' => 'before',
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .embroidery-custom-embed-play i' => 'font-size: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'show_image_overlay' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .embroidery-custom-embed-play i',
				'fields_options' => [
					'text_shadow_type' => [
						'label' => _x( 'Shadow', 'Text Shadow Control', 'embroidery' ),
					],
				],
				'condition' => [
					'show_image_overlay' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'#embroidery-lightbox-{{ID}}' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'#embroidery-lightbox-{{ID}} .dialog-lightbox-close-button' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'#embroidery-lightbox-{{ID}} .dialog-lightbox-close-button:hover' => 'color: {{VALUE}}',
				],
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'(desktop+)#embroidery-lightbox-{{ID}} .embroidery-video-container' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'frontend_available' => true,
				'options' => [
					'' => __( 'Center', 'embroidery' ),
					'top' => __( 'Top', 'embroidery' ),
				],
				'selectors' => [
					'#embroidery-lightbox-{{ID}} .embroidery-video-container' => '{{VALUE}}; transform: translateX(-50%);',
				],
	...
	protected function render() {
		...
		$this->add_render_attribute( 'video-wrapper', 'class', 'embroidery-wrapper' );

		if ( ! $settings['lightbox'] ) {
			$this->add_render_attribute( 'video-wrapper', 'class', 'embroidery-fit-aspect-ratio' );
		}

		$this->add_render_attribute( 'video-wrapper', 'class', 'embroidery-open-' . ( $settings['lightbox'] ? 'lightbox' : 'inline' ) );
		?>
		<div <?php echo $this->get_render_attribute_string( 'video-wrapper' ); ?>>
			...
			if ( $this->has_image_overlay() ) {
				$this->add_render_attribute( 'image-overlay', 'class', 'embroidery-custom-embed-image-overlay' );
				...
				if ( $settings['lightbox'] ) {
					$lightbox_options = [
						...
						'modalOptions' => [
							'id' => 'embroidery-lightbox-' . $this->get_id(),
					...
					$this->add_render_attribute( 'image-overlay', [
						...
						'data-embroidery-open-lightbox' => 'yes',
						'data-embroidery-lightbox' => wp_json_encode( $lightbox_options ),
					] );
				} else {
				...
				<div <?php echo $this->get_render_attribute_string( 'image-overlay' ); ?>>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ) : ?>
						<div class="embroidery-custom-embed-play">
