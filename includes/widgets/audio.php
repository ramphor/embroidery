...
/**
 * Embroidery audio widget.
 *
 * Embroidery widget that displays an audio player.
 *
 * @since 1.0.0
 */
class Widget_Audio extends Widget_Base {
	...
	public function get_title() {
		return __( 'SoundCloud', 'embroidery' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_audio',
			[
				'label' => __( 'SoundCloud', 'embroidery' ),
			]
		);
		...
		$this->add_control(
			'visual',
			[
				'label' => __( 'Visual Player', 'embroidery' ),
		...
		$this->add_control(
			'sc_buying',
			[
				'label' => __( 'Buy Button', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'sc_liking',
			[
				'label' => __( 'Like Button', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_download',
			[
				'label' => __( 'Download Button', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_sharing',
			[
				'label' => __( 'Share Button', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
		...
		$this->add_control(
			'sc_show_playcount',
			[
				'label' => __( 'Play Counts', 'embroidery' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'embroidery' ),
				'label_on' => __( 'Show', 'embroidery' ),
				'default' => 'yes',
	...
	protected function render() {
		...
		if ( $video_html ) : ?>
			<div class="embroidery-soundcloud-wrapper">
				<?php echo $video_html; ?>
			</div>
		<?php
		endif;
