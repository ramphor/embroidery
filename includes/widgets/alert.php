...
class Widget_Alert extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'This is an Alert', 'embroidery' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'I am a description. Click the edit button to change this text.', 'embroidery' ),
				'separator' => 'none',
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			'show_dismiss',
			[
				'label' => __( 'Dismiss Button', 'embroidery' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'show',
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .embroidery-alert' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .embroidery-alert' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'border_left-width',
			[
				'label' => __( 'Left Border Width', 'embroidery' ),
				...
				'selectors' => [
					'{{WRAPPER}} .embroidery-alert' => 'border-left-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .embroidery-alert-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'alert_title',
				'selector' => '{{WRAPPER}} .embroidery-alert-title',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .embroidery-alert-description' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .embroidery-alert-description',
	...
	protected function render() {
		...
		if ( ! empty( $settings['alert_type'] ) ) {
			$this->add_render_attribute( 'wrapper', 'class', 'embroidery-alert embroidery-alert-' . $settings['alert_type'] );
		}

		$this->add_render_attribute( 'wrapper', 'role', 'alert' );

		$this->add_render_attribute( 'alert_title', 'class', 'embroidery-alert-title' );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			...
			<?php if ( ! empty( $settings['alert_description'] ) ) {
				$this->add_render_attribute( 'alert_description', 'class', 'embroidery-alert-description' );
			...
			if ( 'show' === $settings['show_dismiss'] ) { ?>
				<button type="button" class="embroidery-alert-dismiss">
					<span aria-hidden="true">&times;</span>
					<span class="embroidery-screen-only"><?php esc_html_e( 'Dismiss alert', 'embroidery' ); ?></span>
				</button>
			<?php } ?>
		</div>
		<?php
	...
	protected function _content_template() {
		...
		<# if ( settings.alert_title ) {
			view.addRenderAttribute( {
				alert_title: { class: 'embroidery-alert-title' },
				alert_description: { class: 'embroidery-alert-description' }
			} );

			view.addInlineEditingAttributes( 'alert_title', 'none' );
			view.addInlineEditingAttributes( 'alert_description' );
			#>
			<div class="embroidery-alert embroidery-alert-{{ settings.alert_type }}" role="alert">
