...
/**
 * Embroidery WordPress widget.
 *
 * Embroidery widget that displays all the WordPress widgets.
 *
 * @since 1.0.0
 */
class Widget_WordPress extends Widget_Base {
	 ...
	 *
	 * Returns the WordPress widget form, to be used in Embroidery.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Returns an instance of WordPress widget, to be used in Embroidery.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Returns the WordPress widget settings, to be used in Embroidery.
	 *
	 * @access protected
	 * @since 1.0.0
	 *
	...
	protected function render() {
		 ...
		 *
		 * Filters the WordPress widget arguments when they are rendered in Embroidery panel.
		 *
		 * @since 1.0.0
		 *
		 ...
		 */
		$default_widget_args = apply_filters( 'embroidery/widgets/wordpress/widget_args', $default_widget_args, $this ); // WPCS: spelling ok.
