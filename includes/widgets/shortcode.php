...
/**
 * Embroidery shortcode widget.
 *
 * Embroidery widget that insert any shortcodes into the page.
 *
 * @since 1.0.0
 */
class Widget_Shortcode extends Widget_Base {
	...
	public function get_title() {
		return __( 'Shortcode', 'embroidery' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'shortcode',
			[
				'label' => __( 'Enter your shortcode', 'embroidery' ),
	...
	protected function render() {
		...
		?>
		<div class="embroidery-shortcode"><?php echo $shortcode; ?></div>
		<?php
	}
