...
/**
 * Embroidery HTML widget.
 *
 * Embroidery widget that insert a custom HTML code into the page.
 *
 * @since 1.0.0
 */
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'placeholder' => __( 'Enter your code', 'embroidery' ),
				'show_label' => false,
			]
		);
