...
/**
 * Embroidery spacer widget.
 *
 * Embroidery widget that inserts a space that divides various elements.
 *
 * @since 1.0.0
 */
class Widget_Spacer extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .embroidery-spacer-inner' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		?>
		<div class="embroidery-spacer">
			<div class="embroidery-spacer-inner"></div>
		</div>
		<?php
	}
