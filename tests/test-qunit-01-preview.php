...
class Embroidery_Test_Qunit_Preview extends WP_UnitTestCase {
	...
	public function setUp() {
		...
		\Embroidery\Plugin::$instance->preview->init();
		...
		\Embroidery\Plugin::$instance->frontend = new \Embroidery\Frontend();
		...
		$plugin_path = str_replace( '\\', '/', EMBROIDERY_PATH );
		$quint = '' .
